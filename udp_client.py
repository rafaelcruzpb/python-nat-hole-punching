...
core_file = '/home/$USER/.var/app/org.libretro.RetroArch/config/retroarch/cores/blastem_libretro.so'
rom_file = '~/Downloads/sr2.zip'
...
def listen(sock, player):
    ...
    while True:
        ...
        if started is False and player == '2':
